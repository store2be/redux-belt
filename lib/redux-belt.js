...
exports.default = actionsNamespace;

var _utils = __webpack_require__(1);

function actionsNamespace(prefix, baseActionTypes) {
  ...
  for (var i = 0; i < baseActionTypes.length; i += 1) {
    ...
    actions[camelCaseActionType] = (0, _utils.actionCreator)(types[actionType], { successType: successType, failureType: failureType });
  }

  return _extends({}, types, actions);
}
...
exports.crudActionsNamespace = crudActionsNamespace;
exports.crudReducer = crudReducer;

var _immutabilityHelper = __webpack_require__(8);

var _immutabilityHelper2 = _interopRequireDefault(_immutabilityHelper);

var _actionsNamespace = __webpack_require__(3);

var _actionsNamespace2 = _interopRequireDefault(_actionsNamespace);
...
function crudActionsNamespace(prefix) {
  var actionTypes = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];

  return (0, _actionsNamespace2.default)(prefix, [].concat(crudActionTypes, _toConsumableArray(actionTypes)));
}
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            throw new Error('The action ' + action.type + ' is not generated by redux-belt/actionsNamespace and lacks the required "meta" property');
...
Object.defineProperty(exports, 'actionsNamespace', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_actionsNamespace).default;
  }
});

var _simpleAsync = __webpack_require__(7);
...
var _crud = __webpack_require__(6);

Object.defineProperty(exports, 'crudActionsNamespace', {
  enumerable: true,
  get: function get() {
    return _crud.crudActionsNamespace;
  }
});

 ...
 */
var setFiltersMaybe = exports.setFiltersMaybe = function setFiltersMaybe(newFilters) {
  return function (oldFilters) {
    var defaultFilters = _extends({
      setFilters: true
    }, newFilters);
...
exports.crudReducer = exports.defaultExtractors = exports.configureCrudReducer = exports.crudState = undefined;
...
var crudActionTypes = ['CANCEL_LOADING', 'CREATE', 'DELETE', 'FETCH_INDEX', 'FETCH_SINGLE', 'MERGE_CHANGES', 'SET_CHANGES', 'UPDATE'];
...
var configureCrudReducer = exports.configureCrudReducer = function configureCrudReducer(extractors) {
  return function (state, action, t) {
    ...
    switch (type) {
      ...
      case t.FETCH_INDEX:
        return (0, _immutabilityHelper2.default)(state, {
          filters: { $apply: (0, _utils.setFiltersMaybe)(payload) },
          loading: {
            index: { $set: true }
          }
        });
      ...
      case t.UPDATE_SUCCESS:
        return (0, _immutabilityHelper2.default)(state, {
          ...
          changes: { $set: {} },
          errors: { $set: [] },
          index: { $apply: (0, _utils.replaceEntry)(extractors.single(action, state)) },
          single: { $set: extractors.single(action, state) }
        });
...
var defaultExtractors = exports.defaultExtractors = {
  index: function index(action) {
  ...
  single: function single(action) {
    return action.payload;
  }
};

var crudReducer = exports.crudReducer = configureCrudReducer(defaultExtractors);
...
Object.defineProperty(exports, 'configureCrudReducer', {
  enumerable: true,
  get: function get() {
    return _crud.configureCrudReducer;
  }
});
